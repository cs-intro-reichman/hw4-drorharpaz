...
public class ArrCharOps {
    public static void main(String[] args) {
        ...
        System.out.println(equals(arr2, arr3));                         // True
        ...
        System.out.println(subArray(arr2, 2, 9));   // derstoo
        ...
        System.out.print("Your hash code is " + hashCode(arr1));
        System.out.print(", the correrct hash cod is " + arr1.hashCode() + " --> ");
        System.out.println(hashCode(arr1) == arr1.hashCode() ? "True" : "False");
        System.out.print("Your hash code is " + hashCode(arr2));
        System.out.print(", the correrct hash cod is " + arr2.hashCode() + " --> ");
        System.out.println(hashCode(arr2) == arr2.hashCode() ? "True" : "False");
    }
    ...
    */
    ...
    public static int compareTo(String str1, String str2) {
        ...
        if (str1.length() > str2.length())          {return -1 * compareTo(str2, str1);}
